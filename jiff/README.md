...
* `SignedDuration64<precision>` - wraps `jiff::SignedDuration`, corresponds to ClickHouse's [`Time64(precision)`](https://clickhouse.com/docs/sql-reference/data-types/time64);
...
* `Timestamp64<precision>` - wraps `jiff::Timestamp`, corresponds to ClickHouse's [`DateTime64(precision)`](https://clickhouse.com/docs/sql-reference/data-types/datetime64).
